...
var codegenMatch = regexp.MustCompile(`// Code generated by .*`)
var thriftCodegen = regexp.MustCompile(`// Autogenerated by .*`)

func IsCodegenLine(line string) bool {
	return codegenMatch.MatchString(line) || thriftCodegen.MatchString(line)
}
